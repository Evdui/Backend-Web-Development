...
// readFile loads the entire file into memory at once, so the amount of memory
// used grows with the size of the file. A stream moves the file in smaller
// chunks, so it uses much less memory and keeps peak memory roughly flat even
